...
export const GACPHOME = `${process.env.HOME || process.env.HOMEPATH || process.env.USERPROFILE}/.gacp`;
...
export const COMMIT_TYPES_CONFIG_FILE_NAME = `conventional-commit-types.json`;
